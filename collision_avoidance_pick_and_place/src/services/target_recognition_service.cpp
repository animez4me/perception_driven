...
protected:
    ...
    if(get_transform(world_frame_id_,msg.header.frame_id,world_to_sensor_tf) &&
       ...
       get_transform(world_frame_id_ ,"clickedpt",world_to_ar_tf))
    {
...
//      if(transform_listener_ptr->frameExists("clickedpt")){
//        ROS_INFO_STREAM("clickedpt exist");
//      }
//      else
//        ROS_INFO_STREAM("clickedpt doesnt exist");

//      if(transform_listener_ptr->waitForTransform(target,source,ros::Time::now(),ros::Duration(4.0f))){
//        ROS_WARN_STREAM("HEARD");
//        heard = true;
//      }
//      else
//        ROS_ERROR_STREAM("missed");
